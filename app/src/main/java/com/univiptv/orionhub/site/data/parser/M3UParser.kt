...
object M3UParser {
    ...
    private fun parseExtInf(line: String): ExtInfInfo {
        ...
        val drmKeyId = extractAttribute(line, "drm-key-id")
        val drmKey = extractAttribute(line, "drm-key")
        val drmLicenseUrl = extractAttribute(line, "drm-license")
        return ExtInfInfo(name, logoUrl, category, language, drmKeyId, drmKey, drmLicenseUrl)
    }
